...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Hàng hóa',url:'',icon:'signal',childs:[{name:'Quản lý tin tức',url:'/product/news'},{name:'Quản lý đơn hàng',url:'/product/order'},{name:'Quản lý loại hàng',url:'/product/type'},{name:'Quản lý sản phẩm',url:'/product/product'}]}];
  constructor() { } 
  ngOnInit(): void {
  }
  ngAfterViewInit() {
